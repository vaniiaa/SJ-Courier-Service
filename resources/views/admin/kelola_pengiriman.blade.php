    ...
    <div class="max-w-[90rem] mx-auto bg-white rounded-lg shadow-lg p-4">
        ...
        <div class="overflow-x-auto border border-gray-300 rounded-lg">
            <table class="w-full table-auto text-sm rounded-lg overflow-hidden">
                ...
                @php
                    $pengiriman = [
                        ['123456', 'John Doe', 'Jl. Punggur No.1', 'Dewi Lestari', 'Jl. Botania Raya', 'Kurir A', '2025-04-09', 2.5, 25000, 'menunggu konfirmasi'],
                        ['654321', 'Sarah Lee', 'Jl. Nongsa No.12', 'Budi Santoso', 'Jl. Tiban Indah', 'Kurir B', '2025-04-08', 1.2, 15000, 'menunggu konfirmasi'],
                        ['111222', 'Rizal Pratama', 'Jl. Sadai No.45', 'Rani Wijaya', 'Jl. Batu Aji Lama', 'Kurir C', '2025-04-07', 3.0, 30000, 'menunggu konfirmasi'],
                        ['333444', 'Nina Fitria', 'Jl. Marina No.3', 'Yanto Pratama', 'Jl. Citra Mas', 'Kurir D', '2025-04-06', 1.5, 18000, 'menunggu konfirmasi'],
                        ['555666', 'Tommy Lim', 'Jl. Barelang No.20', 'Sinta Ayu', 'Jl. Gajah Mada', 'Kurir E', '2025-04-05', 2.0, 22000, 'menunggu konfirmasi'],
                    ...
                    <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-100' }}">
                        ...
                        <td class="px-4 py-2 text-center">
                            <div class="flex justify-center gap-2">
                                @if ($index < 5)
                                    <button class="w-28 bg-red-500 text-white py-1 rounded text-xs hover:bg-red-600 shadow-md shadow-gray-700">Tentukan Kurir</button>
                                @endif
                                <button class="px-3 bg-blue-500 text-white py-1 rounded text-xs hover:bg-blue-600 shadow-md shadow-gray-700">Detail</button>
                            </div>
                        </td>
                    </tr>
                @endforeach
